...
$query = "SELECT * FROM tentang ORDER BY id DESC";
...
<html>  
 ...
 <body>  
  ...
  <div class="container" style="width:700px;"> 
   <h3 align="center">Input List Dirimu</h3>  
   <br />  
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title">Input List Dirimu</h4>
   </div>
...
<div id="dataModal" class="modal fade">
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h4 class="modal-title">Detail List Dirimu</h4>
   </div>
...
<div id="editModal" class="modal fade">
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h4 class="modal-title">Edit List Dirimu</h4>
   </div>
